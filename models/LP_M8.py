...
now = datetime.now()
output_path = settings["output"] + "LP_M8_" + str(now.day) + "-" + str(now.month) + "-" + str(now.year) + "_" + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second) + ".txt"
with open(output_path, "w") as output:
    ...
    for epoch in range(1, 50):
        ...
        if val_auc > best_val_auc:
            output_model = settings["output"] + "model_LP_M8_" + str(now.day) + "-" + str(now.month) + "-" + str(now.year) + "_" + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second) + "_E" + str(epoch) + ".pth"
