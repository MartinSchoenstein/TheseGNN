...
now = datetime.now()
output_path = settings["output"] + "LP_M5_" + str(now.day) + "-" + str(now.month) + "-" + str(now.year) + "_" + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second) + ".txt"
with open(output_path, "a") as output:
    ...
    for epoch in range(1, 50):
        ...
        if val_auc > best_val_auc:
            ...
            count = 0
            output_model = settings["output"] + "model_LP_M5-1_" + str(now.day) + "-" + str(now.month) + "-" + str(now.year) + "_" + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second) + "_E" + str(epoch) + ".pth"
            torch.save(model_n2v.state_dict(), output_model)
            output_model = settings["output"] + "model_LP_M5-2_" + str(now.day) + "-" + str(now.month) + "-" + str(now.year) + "_" + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second) + "_E" + str(epoch) + ".pth"
